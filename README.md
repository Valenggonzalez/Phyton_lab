...
Este proyecto consiste en un sistema de gestión de estacionamiento desarrollado en Python para consola.
...
Todo el código fue revisado, comprendido y adaptado por los integrantes del grupo antes de ser incorporado al proyecto.
